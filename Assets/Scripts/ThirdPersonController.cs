        ...
        private PlayerInput _playerInput;
          ...
          private void CameraRotation()
          {
               ...
               if (_input.look.sqrMagnitude >= _threshold && !LockCameraPosition)
               {
                    ...
                    _cinemachineTargetYaw += _input.look.x * deltaTimeMultiplier * LookSensivity;
                    _cinemachineTargetPitch += _input.look.y * deltaTimeMultiplier * LookSensivity;
               }
